...
class Agent:
    ...
    def init_writer(self):
        self.writer = SummaryWriter(log_dir='runs/PPO_discrete/env_{}_number_{}_seed_{}'.format(self.env_name, 1, self.seed))
    ...
    def evaluate_step(self, ):
        ...
        if self.evaluate_num % self.args.save_freq == 0:
            np.save('data/PPO_discrete_env_{}_number_{}_seed_{}.npy'.format(self.env_name, 1, self.seed), np.array(self.evaluate_rewards))
